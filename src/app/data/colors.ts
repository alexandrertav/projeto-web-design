    ...
    movies: [
      {
        ...
        colorExplanation: 'pastel domina o universo visual do filme, pintando o hotel e suas embalagens de confeitaria com uma aura de nostalgia e perfeição estética. Esse rosa não é apenas decorativo: ele traduz o mundo idealizado de M. Gustave e de sua era elegante, polida e frágil diante da brutalidade do tempo. Na cena das caixas Mendls, o rosa funciona como um refúgio da ternura, um microcosmo protegido da guerra e da decadência. Mas, ao mesmo tempo, sua suavidade revela o caráter ilusório dessa beleza, o rosa é a cor de um passado que tenta resistir ao colapso.'
      },
        {
        id: 'harry-potter',
        title: 'harry potter e a ordem da fênix (2014)',
        image: '/movies/hp-fenix.png',
        colorExplanation: 'no escritório de Dolores Umbridge adquire um sentido oposto: a doçura transformada em controle. Aqui, o tom não é afetuoso, mas opressor e artificial, um verniz de gentileza que esconde autoritarismo. As paredes cobertas de flores, rendas e gatos criam uma estética infantilizada, quase caricata, que disfarça a crueldade da personagem. O rosa, que poderia ser símbolo de amor e empatia, torna-se instrumento de manipulação emocional, um lembrete de como o poder também pode se disfarçar de delicadeza.'
      },
      {
        id: 'blade-rosa',
        title: 'blade runner 2049 (2017)',
        image: '/movies/blade-rosa.png',
        colorExplanation: 'neon neste universo futurista e melancólico não representa carinho, mas simulação e desejo artificial. É o rosa das luzes de propaganda, da sensualidade programada, das emoções fabricadas. A tonalidade vibrante que envolve o holograma e o protagonista cria uma atmosfera de solidão tecnológica: o calor da cor contrasta com o vazio da cena. É o rosa da pós-humanidade, sedutor e sintético, símbolo de uma ternura que já não nasce do humano, mas é projetada por máquinas.'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    movies: [
      ...
      },
      {
        ...
        colorExplanation: 'em Donnie Darko envolve a narrativa como uma névoa de mistério e angústia existencial. Ele colore o mundo de sonhos, delírios e premonições, onde o tempo se distorce e a morte se torna uma presença íntima. O preto é a cor do subconsciente que desperta, o véu entre a realidade e o delírio, entre o ser e o deixar de ser. O coelho metálico e as sombras reforçam a sensação de que algo está por trás daquilo que se vê. Aqui, o preto não é apenas medo: é pressentimento, o chamado do desconhecido que revela o destino. É a cor da pergunta sem resposta, do mergulho interior que consome e transforma.'
      }
    ]
  }
];
