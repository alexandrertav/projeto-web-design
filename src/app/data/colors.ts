...
export const colorsData: ColorData[] = [
  ...
  },
  {
    ...
    name: 'Roxo',
    hexColor: '#8B09AC',
    description: 'na psicologia das cores está ligado ao mistério, à espiritualidade e à introspecção. Ele representa o encontro entre o vermelho (paixão, energia) e o azul (tranquilidade, razão), simbolizando equilíbrio entre emoção e mente. É a cor da imaginação, da intuição e do poder simbólico, frequentemente associada ao sagrado, ao sonho e ao inconsciente. Contudo, quando o roxo se intensifica ou escurece, pode adquirir conotações de isolamento, melancolia ou obsessão, tornando-se uma cor de transição, entre o visível e o oculto, o real e o espiritual.',
    movies: [
      {
        id: 'pantera-negra',
        title: "pantera negra (2018)",
        image: '/movies/pantera-negra.png',
        colorExplanation: 'na cena iluminada pelas auroras roxas do plano ancestral traduz a conexão entre o espiritual e o terreno. A cor envolve o protagonista num ambiente sereno e transcendente, marcando o reencontro com seus antepassados.\n\n Aqui, o roxo é a cor da ancestralidade e da energia vital, funcionando como ponte entre mundos, o dos vivos e o dos mortos, o do presente e o da memória. É uma tonalidade que irradia respeito e poder, mas também paz e continuidade. O brilho etéreo do céu roxo faz do espaço uma espécie de útero cósmico, onde o herói renasce espiritualmente, carregando a força de seu povo.'
      },
        {
        id: 'guardioes-da-galaxia',
        title: 'Guardiões da Galáxia (2014)',
        image: '/movies/guardioes-da-galaxia.png',
        colorExplanation: 'neste momento de união e sacrifício assume um tom explosivo e energético, representando o poder e o risco da conexão. É a cor do infinito, do cósmico, a energia que ultrapassa os limites humanos.\n\n O roxo, aqui, simboliza tanto a destruição quanto a transcendência: é a matéria do universo e o elo entre os guardiões. A intensidade da cor revela a fusão entre seus corpos e almas, marcando o instante em que o grupo se torna uma unidade. O brilho violento e pulsante do roxo expressa a dualidade da cor, é belo e perigoso, espiritual e atômico, vida e morte coexistindo num mesmo instante.'
      },
      {
        id: 'coraline',
        title: 'Coraline e o Mundo Secreto (2009)',
        image: '/movies/coraline.png',
        colorExplanation: 'em Coraline é o tom do estranho e do sedutor, o fio que separa o mundo real do mundo ilusório. Nas cenas da “outra mãe”, o roxo domina com sua atmosfera misteriosa e onírica, envolvendo o perigo em um manto de fascínio.\n\n A cor aqui é armadilha e encanto: desperta curiosidade, mas carrega algo sombrio. O roxo funciona como a cor do limiar, nem luz nem escuridão, o espaço ambíguo onde o belo se mistura ao assustador. Ele traduz a tentação do sonho perfeito que, aos poucos, se revela pesadelo.'
      }
    ]
  },
  {
    ...
    name: 'Marrom',
    hexColor: '#7C580B',
    description: 'na psicologia das cores é uma cor muito rica em significados ligados à terra, segurança e realidade concreta. Ele transmite sensações de estabilidade, conforto e responsabilidade, mas também pode carregar nuances de melancolia ou rigidez, dependendo do contexto.',
    movies: [
      {
        id: 'oppenheimer',
        title: "Oppenheimer (2023)",
        image: '/movies/oppenheimer.png',
        colorExplanation: 'na cena do trem de Oppenheimer traduz o peso moral e histórico das decisões sendo discutidas. Ele cria uma atmosfera fechada, quente e densa, simbolizando a culpa, a responsabilidade e a materialidade daquilo que Oppenheimer começa a construir.\n\n É uma cor de terra e carne, lembrando o espectador de que, por trás da teoria e da ciência, há humanidade, falibilidade e consequência.'
      },
        {
        id: 'grande-hotel-budapeste-marrom',
        title: 'O Grande Hotel Budapeste (2014)',
        image: '/movies/grande-hotel-budapeste-marrom.png',
        colorExplanation: 'aqui é a base neutra que equilibra os contrastes entre cores mais saturadas (como o azul do personagem à esquerda e o cinza-claro do personagem à direita).\n\n O marrom, sendo um tom quente e terroso, cria: uma atmosfera nostálgica, remetendo ao passado (a era de ouro do hotel); uma sensação de decadência elegante, já que o ambiente parece luxuoso, mas desgastado; uma textura emocional de estabilidade e memória;  O marrom é a cor da madeira, do antigo, do que tem história.'  
      },
      {
        id: 'django',
        title: 'DJANGO LIVRE (2012)',
        image: '/movies/django.png',
        colorExplanation: 'em Django Livre simboliza o luxo corrupto e o poder brutal. Ele não acolhe, ele domina. A paleta quente transforma a cena em um retrato de violência mascarada por civilização, um calor dourado que queima por dentro.\n\n O ambiente e as cores são, juntos, o espelho da vaidade e crueldade refinada de Calvin Candie.'
      }
    ]
  },
  {
    ...
    name: 'Branco',
    hexColor: '#FFFFFF',
    description: 'na psicologia das cores está ligado à pureza, paz e renovação. Ele representa o início e o fim, o vazio e a possibilidade, uma tela em branco onde tudo pode ser criado. É a cor da luz total, associada à espiritualidade, à verdade e à transcendência. Porém, em excesso, o branco também pode transmitir frieza, isolamento e esterilidade, tornando-se um símbolo da ausência de emoção ou da anulação do sujeito diante do infinito. É uma cor paradoxal: tanto presença absoluta quanto apagamento, um espaço entre o ser e o desaparecer.',
    movies: [
      {
        id: 'blade-branco',
        title: "blade runner 2049 (2017)",
        image: '/movies/blade-branco.png',
        colorExplanation: 'da neve nesta cena final cobre o personagem em um silêncio absoluto, dissolvendo-o no ambiente. A cor, aqui, não é pureza, mas esvaziamento: o branco do fim, da entrega, da aceitação da morte. A neve envolve o corpo como um lençol fúnebre, simbolizando a paz alcançada apenas na dissolução do eu.\n\n O contraste entre o corpo escuro e o chão branco evidencia o apagamento do homem diante do mundo, um gesto de reconciliação e rendição. O branco não é esperança, mas transcendência melancólica, o instante em que o humano se torna memória no espaço gelado do futuro.'
      },
        {
        id: 'interestelar',
        title: 'interestelar (2014)',
        image: '/movies/interestelar.png',
        colorExplanation: 'no planeta gelado é o símbolo da solidão cósmica e da infinitude. É o branco do desconhecido, da ciência em seu limite, uma cor que ao mesmo tempo purifica e ameaça. A paisagem branca e desolada parece suspender o tempo, confrontando o personagem com o vazio do universo e de si mesmo.\n\n O branco aqui é existencial, não celestial: representa a busca pelo sentido em meio ao nada, a tentativa humana de encontrar calor e fé no gelo do infinito. É a cor do absoluto, o espaço onde a razão e a emoção se encontram e se desfazem diante da vastidão.'  
      },
      {
        id: 'todo-poderoso',
        title: 'TODO PODEROSO (2003)',
        image: '/movies/deus-branco.png',
        colorExplanation: 'no espaço onde Bruce encontra Deus simboliza luz, perdão e recomeço. É um branco espiritual, envolto em serenidade, que remete à iluminação e à reconciliação consigo mesmo. Aqui, o branco não apaga, ele revela. A ausência de cor é também a presença do divino, o ambiente onde tudo se torna claro e possível.\n\n O tom suave e radiante expressa a purificação interior do personagem, o momento em que o humano se encontra com o sagrado e entende o valor da humildade.'
      }
    ]
  },
  {
    ...
    name: 'Preto',
    hexColor: '#0D0E0E',
    description: 'na psicologia das cores está associado à profundidade, poder, mistério e limite. É a cor do desconhecido, do silêncio absoluto, mas também da força interior e da resistência. Representa tanto o vazio quanto a concentração máxima de energia, podendo evocar elegância e autoridade, mas também medo, isolamento e morte simbólica. O preto é a cor da transformação, do que se dissolve para renascer. Ele marca o espaço entre o fim e o início, entre a dor e o renascimento, é a cor da introspecção extrema, onde a luz ainda não chegou, mas está prestes a surgir.',
    movies: [
      {
        id: 'batson',
        title: "THe batman (2022)",
        image: '/movies/batson.png',
        colorExplanation: 'domina o universo de The Batman, não apenas como estética, mas como expressão psicológica. O herói emerge da escuridão não para escondê-la, mas porque ela é sua morada emocional. Aqui, o preto traduz luto e busca, a tentativa de controlar o caos interno através do anonimato. O rosto coberto, o olhar em meio à sombra, e a maquiagem borrada sugerem um personagem que se confunde com a própria noite.\n\n Na psicologia das cores, esse preto é o do trauma, o da ausência de luz que molda a identidade. Ele não é vazio, mas densidade, um escudo simbólico contra o desamparo. É o peso da dor transformado em armadura.'
      },
        {
        id: 'interestelar-preto',
        title: 'interestelar (2014)',
        image: '/movies/interestelar-preto.png',
        colorExplanation: 'no interior do buraco negro é a imagem do desconhecido absoluto, o limite entre o espaço e o tempo, entre o humano e o cósmico. A cor aqui não representa destruição, mas transcendência: o momento em que o personagem se entrega ao invisível e confia no desconhecido para encontrar a verdade. O preto é o útero do universo, um vazio criador.\n\n Ele simboliza o colapso e o nascimento simultâneo, a fusão entre ciência e fé. Dentro dessa escuridão total, tudo parece desaparecer, mas é nela que o sentido se recria.'  
      },
      {
        id: 'darko',
        title: 'Donnie Darko (2001)',
        image: '/movies/darko.png',
        colorExplanation: 'em Donnie Darko envolve a narrativa como uma névoa de mistério e angústia existencial. Ele colore o mundo de sonhos, delírios e premonições, onde o tempo se distorce e a morte se torna uma presença íntima. O preto é a cor do subconsciente que desperta, o véu entre a realidade e o delírio, entre o ser e o deixar de ser. O coelho metálico e as sombras reforçam a sensação de que algo está por trás daquilo que se vê.\n\n Aqui, o preto não é apenas medo: é pressentimento, o chamado do desconhecido que revela o destino. É a cor da pergunta sem resposta, do mergulho interior que consome e transforma.'
      }
    ]
  }
];
